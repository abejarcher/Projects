        ...
        while (Retry >= 0)
        {
            try
            {
                if (lo_Connection == null)
                {
                    ...
                    lo_Connection.ConnectionString = "Data Source=essql1.walton.uark.edu;Initial Catalog=DASC_Spring2025_Shipp_TeamDelta;user id=db_Login;password=DbPass_32gkXEfc;Persist Security Info=False;";
                }
